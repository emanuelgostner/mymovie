...
import "./MovieItemFavourite.css"

const MovieItemFavourite = ({index, movie, toggleFavourite})=> {
    return (
            ...
            <div>
                ...
                <div className={"movieItem_information"}>
                    <div className={"movieItem_favourite"} onClick={() => toggleFavourite(movie)}>
                        <svg className={"bi bi-heart-fill fav"} width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
...
export default MovieItemFavourite;